    ...
    return (
        <div className='aboutDiv flex flex-col p-8 w-full items-center'>
            <div className="animacionAllay bg-neutral-200 bg-opacity-20 rounded-lg p-5 max-w-screen-sm overflow-hidden relative w-80 md:w-[30rem] lg:w-[35rem] transition-all">
                <img src="/portal.gif" alt="" className='w-16 h-16 absolute right-0' />
                <img src="/portal.gif" alt="" className='w-16 h-16 absolute left-0' id='invertirPortal' />
                <img src='/allay.gif' alt="allay" className='allayGif w-16 h-16 rounded-full transition-all pb-2 animate-[volar3_10s_linear_infinite] sm:animate-[volar_10s_linear_infinite] md:animate-[volar2_12s_linear_infinite]' />
