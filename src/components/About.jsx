...
const About = () => {
    ...
    return (
        <div className='aboutDiv flex flex-col lg:flex-row items-center p-10 gap-4 w-full lg:justify-around'>
            <div className="animacionAllay bg-neutral-800 bg-opacity-50 border border-yellow-500 rounded-lg p-5 overflow-hidden relative w-[28rem] transition-all">
            ...
            <div className="flex flex-col items-center pb-2 justify-evenly w-[28rem] gap-2 lg:h-[28rem] overflow-hidden transition-all">
                ...
                <p className='w-fit h-fit text-yellow-500 text-xl lg:text-2xl text-center'>
                    {lang === 'ESP' ?
