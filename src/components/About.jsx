...
const About = () => {
    return (
        <div className='aboutDiv flex flex-col p-8 w-full items-center'>
            <div className="animacionAllay bg-neutral-200 bg-opacity-20 rounded-lg p-5 w-fit">
                <img src='/allay.gif' alt="allay" className='allayGif w-18 h-16 rounded-full transition-all pb-2' />
                <div className="aboutMe flex flex-col items-center border border-yellow-500 p-2 rounded-lg gap-5 bg-neutral-200 bg-opacity-30 w-fit">
