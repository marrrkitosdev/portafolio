...
const Contacto = () => {
    ...
    return (
        <div className='contactoDiv w-full flex justify-center p-12 text-center'>
            <div className="animacionAllay bg-neutral-800 bg-opacity-50 rounded-lg p-5 overflow-hidden relative w-[22rem] md:w-[30rem] lg:w-[42rem] transition-all flex flex-col gap-4 border border-yellow-500">
