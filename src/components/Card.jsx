...
const Card = ({ parrafo, alinear, urlGitHub, urlNetlify, urlImg }) => {
    return (
        <div className={`card rounded-lg bg-neutral-800 bg-opacity-50 flex flex-col items-center p-2 border border-yellow-500 w-[30rem] h-[30rem] justify-between text-jusftify pt-6 ${alinear}`}>
