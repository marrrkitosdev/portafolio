...
const Card = ({ parrafo, urlGitHub, urlNetlify, urlImg }) => {
    return (
        <div className={'card rounded-lg bg-neutral-800 bg-opacity-50 flex flex-col items-center p-2 border border-yellow-500 w-[20rem] md:w-[30rem] lg:w-[16rem] justify-between text-jusftify pt-6'}>
            <img src={urlImg} alt="overview" className='imgCard text-neutral-200 font-light rounded-lg border border-yellow-500' />
            <p className="parraphCard text-yellow-500 text-lg lg:text-md p-2">{parrafo}</p>
